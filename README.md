Build CI: [![Build Status](https://travis-ci.org/Damian-Pumar/Kata-TDD-StringCalculator.svg?branch=master)](https://travis-ci.org/Damian-Pumar/Kata-TDD-StringCalculator)
